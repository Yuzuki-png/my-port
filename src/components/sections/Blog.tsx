  ...
  const projects = [
    {
      ...
      title: "Mimiru バックエンド",
      description:
        "クリーンアーキテクチャを意識して設計・実装（JWT認証、CRUD対応）",
      platform: "github",
    ...
    >
      <Container size="xl">
        <Box className="text-center mb-12 md:mb-16">
          ...
          <Text
            size="lg"
            className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto px-4 md:text-xl"
          >
        ...
        <Box className="mb-16 md:mb-24">
          <Group gap="md" className="mb-6 md:mb-8">
            <Text size="xl" className="md:text-2xl">
              📘
            </Text>
            <Title
              order={3}
              size="lg"
              className="text-gray-800 dark:text-white md:text-xl"
            >
              技術ブログ（Zenn）
            </Title>
          </Group>
                  ...
                  <Stack gap="lg">
                    <Box>
                      ...
                      <Title
                        order={4}
                        size="md"
                        className="mb-3 text-gray-800 dark:text-white md:text-lg"
                      >
                        {post.title}
                      </Title>
                      <Text
                        size="sm"
                        className="text-gray-600 dark:text-gray-300 leading-relaxed md:text-base"
                      >
                        {post.description}
                      </Text>
                    </Box>
                  ...
                  <Stack gap="lg">
                    <Box>
                      ...
                      {project.repo && (
                        <Text
                          size="xs"
                          className="text-blue-600 dark:text-blue-400 mb-3 font-mono md:text-sm"
                        >
                          GitHub: {project.repo}
                        </Text>
                      )}
